...
#include "api/video_codecs/encoded_image.h"
#include "api/video/encoded_image_callback.h"
...
public:
    ...
    webrtc::Result OnEncodedImage(const webrtc::EncodedImage& encoded_image,
